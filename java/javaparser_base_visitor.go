...
func (v *BaseJavaParserVisitor) VisitInstanceOfOperatorExpression(ctx *InstanceOfOperatorExpressionContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseJavaParserVisitor) VisitUnaryOperatorExpression(ctx *UnaryOperatorExpressionContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseJavaParserVisitor) VisitObjectCreationExpression(ctx *ObjectCreationExpressionContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseJavaParserVisitor) VisitExpressionLambda(ctx *ExpressionLambdaContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseJavaParserVisitor) VisitPostIncrementDecrementOperatorExpression(ctx *PostIncrementDecrementOperatorExpressionContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseJavaParserVisitor) VisitMemberReferenceExpression(ctx *MemberReferenceExpressionContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseJavaParserVisitor) VisitExpressionSwitch(ctx *ExpressionSwitchContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseJavaParserVisitor) VisitBinaryOperatorExpression(ctx *BinaryOperatorExpressionContext) interface{} {
	return v.VisitChildren(ctx)
}

func (v *BaseJavaParserVisitor) VisitMethodCallExpression(ctx *MethodCallExpressionContext) interface{} {
	return v.VisitChildren(ctx)
}
...
func (v *BaseJavaParserVisitor) VisitSquareBracketExpression(ctx *SquareBracketExpressionContext) interface{} {
	return v.VisitChildren(ctx)
}
