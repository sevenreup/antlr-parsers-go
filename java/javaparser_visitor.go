// Code generated from D:/_Projects/personal/antlr-parsers-go/grammars-v4/java/java/JavaParser.g4 by ANTLR 4.13.2. DO NOT EDIT.
...
type JavaParserVisitor interface {
	...
	// Visit a parse tree produced by JavaParser#InstanceOfOperatorExpression.
	VisitInstanceOfOperatorExpression(ctx *InstanceOfOperatorExpressionContext) interface{}

	// Visit a parse tree produced by JavaParser#UnaryOperatorExpression.
	...
	VisitObjectCreationExpression(ctx *ObjectCreationExpressionContext) interface{}

	// Visit a parse tree produced by JavaParser#ExpressionLambda.
	VisitExpressionLambda(ctx *ExpressionLambdaContext) interface{}

	// Visit a parse tree produced by JavaParser#PostIncrementDecrementOperatorExpression.
	VisitPostIncrementDecrementOperatorExpression(ctx *PostIncrementDecrementOperatorExpressionContext) interface{}

	// Visit a parse tree produced by JavaParser#MemberReferenceExpression.
	VisitMemberReferenceExpression(ctx *MemberReferenceExpressionContext) interface{}

	// Visit a parse tree produced by JavaParser#ExpressionSwitch.
	VisitExpressionSwitch(ctx *ExpressionSwitchContext) interface{}

	// Visit a parse tree produced by JavaParser#BinaryOperatorExpression.
	VisitBinaryOperatorExpression(ctx *BinaryOperatorExpressionContext) interface{}
	...
	// Visit a parse tree produced by JavaParser#SquareBracketExpression.
	VisitSquareBracketExpression(ctx *SquareBracketExpressionContext) interface{}
